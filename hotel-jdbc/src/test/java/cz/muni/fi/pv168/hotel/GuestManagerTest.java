...
public class GuestManagerTest {
    ...
    private final static ZonedDateTime NOW
            = LocalDateTime.of(2019, APRIL, 15, 16, 00).atZone(ZoneId.of("UTC"));
    ...
    public void setUp() throws SQLException, IOException {
        ...
        DBUtils.executeSqlScript(ds, GuestManager.class.getResourceAsStream("/cz.muni.fi.pv168/hotel/createTables.sql"));
    ...
    public void tearDown() throws Exception {
        DBUtils.executeSqlScript(ds, GuestManager.class.getResourceAsStream("/cz.muni.fi.pv168/hotel/dropTables.sql"));
    }
